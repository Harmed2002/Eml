...
const Create = () => {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        data.roles = selected;
        Swal.fire('Aviso!', 'El usuario ha sido creado exitosamente.', 'success')
            ...
            <div className="container mx-auto">
                <div className="card">
                    <div className="card-header">
                        <h4><i className='fas fa-user-plus'></i>
                            <b> Crear</b><span className="font-medium text-indigo-600">/</span>
                            ...
                            <div className="row">
                                ...
                                <div className="col-12 col-sm-6 mb-3">
                                    ...
                                    <MultiSelect
                                        ...
                                        labelledBy={"Selecccionar uno o varios roles"}
                                    />
                                </div>
                            </div>
